...
class admin_page_access_analysis_target_commu extends OpenPNE_Action
{
    function execute($requests)
    {
        ...
        list($target_commu, $sum, $is_prev, $is_next, $total_num, $start_num, $end_num)
                = p_access_analysis_target_commu_target_commu4ym_page_name($ymd, $month_flag, $page_name, $ktai_flag, $page, $page_size, $orderby);
        $this->set("target_commu", $target_commu);
        $this->set("sum", $sum);
