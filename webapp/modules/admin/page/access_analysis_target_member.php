...
class admin_page_access_analysis_target_member extends OpenPNE_Action
{
    function execute($requests)
    {
        ...
        list($target_member, $sum, $is_prev, $is_next, $total_num, $start_num, $end_num)
                = p_access_analysis_target_member_access_member4ym_page_name($ymd, $month_flag, $page_name, $ktai_flag, $page, $page_size, $orderby);
