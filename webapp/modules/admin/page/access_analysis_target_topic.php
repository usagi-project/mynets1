...
class admin_page_access_analysis_target_topic extends OpenPNE_Action
{
    function execute($requests)
    {
        ...
        list($target_topic, $sum, $is_prev, $is_next, $total_num, $start_num, $end_num)
            = p_access_analysis_target_topic_target_topic4ym_page_name($ymd, $month_flag, $page_name, $ktai_flag, $page, $page_size, $orderby);
        $this->set("target_topic", $target_topic);
        $this->set("sum", $sum);
