...
class admin_page_view_delete_member_data extends OpenPNE_Action
{
    function execute($requests)
    {
        //memberID
        $c_delete_member_data_id = $requests['target_c_delete_member_data_id'];
        $member_data = getDeleteMemberDataAdmin($c_delete_member_data_id);
        $v = array();
        $v['SNS_NAME'] = SNS_NAME;
        ...
        $owner_nickname = $owner_member['nickname'];
        $this->set("owner_nickname",$owner_nickname);
        return 'success';
    }
}
