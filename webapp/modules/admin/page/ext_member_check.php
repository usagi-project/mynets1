...
class admin_page_ext_member_check extends OpenPNE_Action
{
    function getTitle()
    {
        return "メンバーの閲覧";
    ...
    function execute($requests)
    {
        ...
        $member_data = getMemberListAdmin($sort_no, $keyword, $page, $page_size, $pager);

        
        $v['SNS_NAME'] = SNS_NAME;
        $v['OPENPNE_VERSION'] = OPENPNE_VERSION;
        $v['c_profile_list'] = db_common_c_profile_list4null();
        $this->set("member_list",$member_data);
        $v['pager'] = $pager;
        $v['sort_no'] = $sort_no;
        $this->set($v);
