...
class admin_page_ext_topic_check extends OpenPNE_Action
{
    function getTitle()
    {
        return "トピックの閲覧";
    ...
    function execute($requests)
    {
        ...
        $topic_data = getTopicDataListAdmin($keyword, $sort_no, $page, $page_size, $pager);

        
        $v['SNS_NAME'] = SNS_NAME;
        $v['OPENPNE_VERSION'] = OPENPNE_VERSION;
        
        $this->set("topic_list",$topic_data);
        $v['pager'] = $pager;
