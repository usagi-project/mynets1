...
<table style="width: 680px">
    ...
    <tr>
        ...
        <td>管理者変更
            ...
            <input type="hidden" name="a" value="do_({$hash_tbl->hash('commu_admin_chenge','do')})">
            <input type="text" size="4" name="target_c_member_id" value=""><br>
