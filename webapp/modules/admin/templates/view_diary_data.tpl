...
<table style="width: 680px">
    <tr>
        <td style="width:180px" class="dataview">c_diary_id</td>
        <td style="width:500px">({$diary_data.c_diary_id})</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>({$diary_data.subject|t_body:'title'})</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="dataview">コメント件数</td>
        <td>({$diary_data.comment_count})&nbsp;&nbsp;<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('ext_diary_comment_check')})&amp;target_c_diary_id=({$diary_data.c_diary_id})">この日記のコメント一覧</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        ({elseif $diary_data.public_flag == 'friend'})フレンドまで公開
        ({else})非公開
        ({/if})
        </td>
    </tr>
