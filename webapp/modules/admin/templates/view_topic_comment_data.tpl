...
<table style="width: 680px">
    ...
    <tr>
        ...
        <td>({$topic_comment_data.nickname|t_body:'name'})(({$topic_comment_data.c_member_id}))</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('view_topic_data')})&amp;target_c_commu_topic_id=({$topic_comment_data.c_commu_topic_id})">({$topic_comment_data.topicname})</a>/c_commu_topic_id：({$topic_comment_data.c_commu_id})</td>
    </tr>
    <tr>
