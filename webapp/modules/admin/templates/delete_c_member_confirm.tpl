...
<p>本当にこのメンバーを強制退会させてもよろしいですか？</p>
<p class="caution">※強制退会させると、このメンバーに関する情報は削除され元に戻すことはできません。</p>
...
退会に対してのコメントをつけられます。<br>
<textarea name="comment" cols="30" rows="4"></textarea><br>
<input type="submit" class="submit" value="強制退会させる">
</form>

<p><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('list_c_member')})" onClick="history.back(); return false;" onKeyPress="history.back(); return false;">メンバーリストにもどる</a></p>
...
<tr>
<th>ニックネーム</th>
<td><a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$c_member.c_member_id})" target="_blank">({$c_member.nickname|t_body:'name'})</a></td>
</tr>
<tr>
<th>最終アクセス</th>
