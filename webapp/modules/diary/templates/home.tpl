...
<td style="width:111px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">最新公開日記</span></td>
</tr>
</table>
({*ここまで：header*})
({*ここから：body*})
...
<div><a href="({t_url m=diary a=page_home})&amp;year=({$date.year})&amp;month=({$date.month})"><img src="./skin/dummy.gif" style="width:14px;height:14px;" class="icon icon_2">({$date.year})年({$date.month})月の一覧</a></div>
...
<tr>
<td style="width:36px;" class="bg_06"><img src="({t_img_url_skin filename=content_header_1})" style="width:30px;height:20px;" class="dummy"></td>
<td style="width:111px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">全体新着RSS</span></td>
</tr>
</table>
({*ここまで：header*})
({*ここから：body*})
...
<a href="({t_url m=diary a=page_detail})&amp;target_c_diary_id=({$item.c_diary_id})">({$item.subject|t_body:'title'})</a>&nbsp;&nbsp;<a href="({t_url m=diary a=page_list})&amp;target_c_member_id=({$item.c_member_id})">({$item.nickname|t_body:'name'})</a>
