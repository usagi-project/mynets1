...
<a href="({t_url m=ktai a=page_c_home})&amp;target_c_commu_id=({$c_commu.c_commu_id})&amp;({$tail})">ｺﾐｭﾆﾃｨ：({$c_commu.name|t_body:'name'})</a><br>
</font></center>
<hr>
<font size="1">
({if $c_commu_topic})

<center>({$c_commu_topic.name|t_body:'title'})</center>
<hr>
...
<a name="({counter name="aa"})"></a>
  <a href="#({counter name="bb"})" accesskey="9">▼</a>
({if $item.number != 0})
