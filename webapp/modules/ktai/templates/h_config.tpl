...
<!--◆<a href="({t_url m=ktai a=page_h_config_message_contents_receive})&amp;({$tail})">ﾒｯｾｰｼﾞ内容受信設定</a><br>-->
...
○<a href="({t_url m=ktai a=page_h_config_display_view})&amp;({$tail})">画面デザイン変更</a><br>
<br>
