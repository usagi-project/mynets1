...
写真1:[<a href="({t_img_url filename=$c_member.image_filename_1 w=120 h=120 f=jpg})">小</a>/<a href="({t_img_url filename=$c_member.image_filename_1 w=360 h=360 f=jpg})">大</a>]
...
写真2:[<a href="({t_img_url filename=$c_member.image_filename_2 w=120 h=120 f=jpg})">小</a>/<a href="({t_img_url filename=$c_member.image_filename_2 w=360 h=360 f=jpg})">大</a>]
...
写真3:[<a href="({t_img_url filename=$c_member.image_filename_3 w=120 h=120 f=jpg})">小</a>/<a href="({t_img_url filename=$c_member.image_filename_3 w=360 h=360 f=jpg})">大</a>]
