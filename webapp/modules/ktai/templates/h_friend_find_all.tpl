...
<p align="center"><font color="orange">ﾒﾝﾊﾞｰ検索</font></p>
<p align="right"><a href="#search">検索入力</a></p><hr>
検索結果(({$pager.total_num})件)<br>
({foreach from=$target_friend_list item=target_friend})
<a href="({t_url m=ktai a=page_f_home})&amp;target_c_member_id=({$target_friend.c_member_id})&amp;({$tail})">({$target_friend.nickname|t_body:'name'})</a><br>
({/foreach})
