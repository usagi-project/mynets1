...
<tr>
({$c_message_received.r_datetime|date_format:"%y/%m/%d"})-({$c_message_received.nickname|t_body:'name'|default:"&nbsp;"})さん<br>
...
({$c_message_sent.r_datetime|date_format:"%y/%m/%d"})-({$c_message_sent.nickname|t_body:'name'|default:"&nbsp;"})さん<br>
