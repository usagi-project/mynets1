...
<td style="width:90px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">検&nbsp;索</span></td>
...
<table border="0" cellspacing="0" cellpadding="0" style="width:562px; margin-right: auto; margin-left: auto; " >
({*********})
<tr>
<td style="width:90px;" class="bg_05" align="left" valign="middle">
...
<input type="checkbox" name="loginnow" value="1" class="no_bg" checked>アクセス順
