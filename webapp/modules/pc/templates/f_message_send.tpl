...
<!-- ******************************************** -->
<!-- ******ここから：メッセージ作成****** -->
({t_form _enctype=file m=pc a=page_f_message_send_confirm _name=editForm})
...
<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_member.c_member_id})">({$target_member.nickname|t_body:'name'})</a>
...
<input name="subject" size="60" value="({$form_val.subject})"  style="width:453px;">
...
<textarea name="body" rows="15" cols="60" style="width:453px;">({$form_val.body})</textarea>
({* BBCode *})
