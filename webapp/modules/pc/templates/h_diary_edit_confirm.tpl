...
<td style="width:528px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">内容を確認し、よければ「決定」をクリックしてください。</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
({$form_val.subject|t_body:'title'|t_geocode})
...
({$form_val.body|bbcode2html|t_body:'diary'|t_replace_d})
...
<tr>
<td>
({t_form m=pc a=do_h_diary_edit_insert_c_diary})
...
<input type="hidden" name="tagsname" value="({$form_val.tagsname})">
<input type="submit" class="submit" value="　決 　定　">
</form></td>
