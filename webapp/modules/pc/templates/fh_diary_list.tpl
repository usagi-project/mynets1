...
<div><a href="({t_url m=pc a=page_fh_diary_list})&amp;target_c_member_id=({$target_member.c_member_id})&amp;year=({$date.year})&amp;month=({$date.month})"><img src="./skin/dummy.gif" style="width:14px;height:14px;" class="icon icon_2">({$date.year})年({$date.month})月の一覧</a></div>
...
<table border="0" cellspacing="0" cellpadding="0" style="width:540px;margin:0px auto;" class="border_07">
     ...
     <tr>
     <td class="bg_00"><img src="./skin/dummy.gif" width="0" class="dummy" style="width:7px;height:7px;"></td>
     <td class="bg_01" align="left">
          ...
          ({*ここから：header*})
                    ...
                    <td style="width:486px;padding:2px 0px;" class="bg_06">
                         <span class="b_b c_00">
                                        ({$target_member.nickname|t_body:'name'})({if $type == "f"})さん({/if})の日記
                                        ({if !$all})
...
<table border="0" cellspacing="0" cellpadding="0" style="width:526px;" class="border_01">
    ...
    ({$page_link|smarty:nodefaults})<br>
          ...
          <!-- ここから：主内容＞＞日記表示 -->
     <table border="0" align="center" cellpadding="0" cellspacing="0"  style="width:526px; border-left:none; border-right:none;">
          ...
          <td style="width:458px;" class="bg_02" align="left" valign="middle">
                    ...
                    ({$item.subject|t_truncate:36:"…"|t_body:'title'})
          ...
          <td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
                    ...
                    <tr>
                    <td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
                    <td style="width:458px;height:1px;" class="bg_01" colspan="3"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
                    </tr>
                    ({*********})
        ...
        <td class="bg_02" align="left" valign="middle">
          ...
          <a href="({t_img_url filename=$item.image_filename_1})" class="thickbox" rel="gallery-plants({$item.c_diary_id})" target="_blank">
          <img src="({t_img_url filename=$item.image_filename_1 w=120 h=120})"></a>
          ({/if})

          ({if $item.image_filename_2})
          <a href="({t_img_url filename=$item.image_filename_2})" class="thickbox" rel="gallery-plants({$item.c_diary_id})" target="_blank">
          <img src="({t_img_url filename=$item.image_filename_2 w=120 h=120})"></a>
          ({/if})

          ({if $item.image_filename_3})
          <a href="({t_img_url filename=$item.image_filename_3})" class="thickbox" rel="gallery-plants({$item.c_diary_id})" target="_blank">
     ...
     <td class="bg_02" align="right" valign="middle">
          ...
          コメント(({$item.comment_count}))
          |閲覧件数:(({$item.etsuran_count}))|
     ...
     <table border="0" cellspacing="0" cellpadding="0" class="border_01" style="width:526px; border-top:none"  >
...
<!-- ここから：主内容＞＞blog表示 -->
     ...
     <table border="0" align="center" cellpadding="0" cellspacing="0"  style="width:526px;">
     ({*********})
     <tr>
     ...
     ({*********})
          ...
          <th style="width:524px;" class="bg_06" colspan="5" valign="middle">

               <span style="display: block; float: left;">
                                                            <img src="({t_img_url_skin filename=content_header_1})" style="margin: 0px;">
                                                            </span>
                                                            <span style=" display: block; float: left;">
               <a name="blog" style="margin-top: auto;margin-bottom: auto;">
               ({if !$all})
               ({$target_member.nickname|t_body:'name'})({if $type == "f"})さん({/if})({$date_val.year})年({$date_val.month})月({if $date_val.day})({$date_val.day})日({/if})のBlog
               ({else})
               ({$target_member.nickname|t_body:'name'})({if $type == "f"})さん({/if})のBlog
               ({/if})
               </a>
               </span>
     ...
     <td style="width:459px;" class="bg_02" align="left" valign="middle">
          ...
          <a href="({$item.link})" target="_blank">({$item.subject|t_truncate:32:"…"|t_body:'title'})</a>
