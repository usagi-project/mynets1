...
<table class="mainframe" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr><td class="container main_content" align="center">
     ...
     ({ext_include file="inc_alert_box.tpl"})({* エラーメッセージコンテナ *})
          ...
          <!-- ************************************ -->
          <!-- ******ここから：紹介文を作成する****** -->
          ({t_form m=pc a=do_f_intro_edit_update_c_friend})
          ...
          <input type="hidden" name="target_c_member_id" value="({$target_member.c_member_id})">
                ...
                <img src="({t_img_url filename=$target_member.image_filename w=76 h=76 noimg=no_image_small})" class="pict"></a><br>

                <a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_member.c_member_id})">({$target_member.nickname|t_body:'name'})</a></div></td>
                </tr>
