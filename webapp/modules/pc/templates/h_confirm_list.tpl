...
<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$item.c_member_id_from})">({$item.nickname|t_body:'name'})</a>
...
<!-- ここから：主内容 -->
<!-- ここから：主内容＞＞メッセージ -->
<div class="border_01 bg_03" align="center" style="padding:3px;text-align:center;">
...
<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$item.c_member_id})">({$item.nickname|t_body:'name'})</a>
...
<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$item.c_member_id_admin})">({$item.nickname|t_body:'name'})</a>
