<div class="border_07 bg_02" style="margin-bottom:5px;" id="item_10">
    ...
    <div id="cnt10" style="display:none">
        ...
        ({if $c_diary_list})
            ...
            <img src="({t_img_url_skin filename=icon_arrow_1})" align="absmiddle">&nbsp;<a href="({t_url m=pc a=page_fh_diary_list})">もっと読む</a></div>
        ({else})
        	<div style="text-align:center;">
            <p style="font-weight:bold;">まだ日記は書かれていません。</p>簡単な自己紹介でＯＫですから、日記を書いてみましょう。<br />
        ({/if})
            <div style="text-align:right;padding:0 5px 5px 5px;">
            <img src="({t_img_url_skin filename=icon_arrow_1})" align="absmiddle">&nbsp;<a href="({t_url m=pc a=page_h_diary_add})">日記を書く</a></div>
        </div>
        ({if $c_blog_list})
