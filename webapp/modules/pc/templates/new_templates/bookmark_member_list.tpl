...
<div class="border_07 bg_02" style="margin-bottom:5px;">
    <div style="padding:3px;margin:1px;" class="bg_06">
        <img src="({t_img_url_skin filename=icon_title_1})" style="cursor:pointer;" align="absmiddle" onClick="paneOnOff(14)" id="mkcnt14">
        <span class="b_b c_00">お気に入りリスト</span>
    </div>
    <div id="cnt14" style="display:none">
...
<!-- ３行目name -->
        ...
        <div style="text-align:right;padding:5px;">
            <img src="({t_img_url_skin filename=icon_arrow_1})" align="absmiddle">&nbsp;<a href="({t_url m=pc a=page_h_bookmark_list})">全てを見る(({$bookmark_count}))</a>
        </div>
    </div>
</div>
({/if})
