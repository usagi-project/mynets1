...
<td style="width:111px;padding:2px 0px;" class="bg_06" align="left"><span class="b_b c_00">タグ一覧</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
({foreach from=$member_tag_list item=item})

<div><a href="({t_url m=pc a=page_fh_diary_list})&amp;target_c_member_id=({$target_member.c_member_id})&amp;c_tags_id=({$item.c_tags_id})"><img src="./skin/dummy.gif" style="width:14px;height:14px;" class="icon icon_2">({$item.c_tags_name.c_tags_name})</a></div>
