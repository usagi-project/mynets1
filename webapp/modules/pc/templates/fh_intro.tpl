...
<img src="({t_img_url filename=$item.image_filename w=76 h=76 noimg=no_image_samll})" class="pict"><br>({$item.nickname|t_body:'name'})</a>
...
({/if})
<br><a href="({t_url m=pc a=do_f_intro_from_delete})&amp;target_c_member_id=({$item.c_member_id})&amp;sessid=({$PHPSESSID})">削除</a><br>
({/if})
