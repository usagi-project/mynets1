...
<img src="({t_img_url filename=$member.image_filename w=76 h=76 noimg=no_image_small})"></a>
...
<input type="hidden" name="target_c_commu_id" value="({$c_commu.c_commu_id})">
<input type="submit" class="submit" type="button" value="キャンセル">
</form>
</td>
