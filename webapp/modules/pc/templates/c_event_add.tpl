...
<!-- ************************************ -->
<!-- ******ここから：新規イベント作成****** -->
({t_form _enctype=file m=pc a=page_c_event_add_confirm _name=editForm})
...
<td style="width:598px;" class="bg_06"><span class="b_b c_00">[({$c_commu.name|t_body:'name'})]&nbsp;新しいイベントを作成する</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
<span class="caution">※のついた項目は必須項目です。</span>
...
<input type="radio" class="no_bg" name="open_flag" value="0"({if $open_flag == 0}) checked="checked"({/if})>公開しない<br><br>

※イベントを外部へ公開します。（外部からは参加、コメント入力はできません）
