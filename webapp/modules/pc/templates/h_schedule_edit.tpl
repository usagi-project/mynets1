...
<!-- ******************************************* -->
<!-- ******ここから：スケジュール入力フォーム****** -->
({t_form m=pc a=page_h_schedule_edit_confirm})
...
<tr><td class="bg_06"><img src="({t_img_url_skin filename=content_header_1})" style="width:30px;height:20px;" class="dummy" align="left"><div class="b_b c_00" style="padding:3px 0px;">予定を編集する</div></td></tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
({*ここから：body*})
...
<textarea name="body" style="width:400;height:150" cols="60" rows="5">({$input.body})</textarea>
