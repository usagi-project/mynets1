...
<!-- ここから：小タイトル -->
									...
									<table border="0" cellspacing="0" cellpadding="0" style="width:644px;">
										<tr>
											...
											<td style="width:468px;padding:2px 0px;" class="bg_06">
												<span class="b_b">イベントを編集する</span></td>
...
({*********})
										<tr>
											<td style="width:644px;height:1px;" class="bg_01" colspan="5">
...
({*********})
											<tr>
												<td style="width:636px;height:1px;" class="bg_01" colspan="5">
													<img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
											</tr>
({*********})
											<tr>
												...
												<td style="width:483px;" class="bg_02" align="left" valign="middle">
													...
													<input type="radio" class="no_bg" name="open_flag" value="1"({if $event.open_flag == 1}) checked="checked"({/if})>公開する
													<br>
													<input type="radio" class="no_bg" name="open_flag" value="0"({if $event.open_flag != 1}) checked="checked"({/if})>公開しない
													<br>
											...
											<tr>
												...
												<td style="width:491px;" class="bg_02" align="left" valign="middle">
													...
													({if $event.image_filename1})
														<img src="({t_img_url filename=$event.image_filename1 w=120 h=120})">
														<a href="({t_url m=pc a=do_c_event_edit_delete_c_commu_topic_comment_image})&amp;target_c_commu_topic_id=({$event.c_commu_topic_id})&amp;pic_delete=1&amp;sessid=({$PHPSESSID})">
														削除</a>
														<br>
													({/if})
											...
											<tr>
												...
												<td style="width:491px;" class="bg_02" align="left" valign="middle">
													...
													({if $event.image_filename2})
														<img src="({t_img_url filename=$event.image_filename2 w=120 h=120})">
														<a href="({t_url m=pc a=do_c_event_edit_delete_c_commu_topic_comment_image})&amp;target_c_commu_topic_id=({$event.c_commu_topic_id})&amp;pic_delete=2&amp;sessid=({$PHPSESSID})">
														削除</a>
														<br>
													({/if})
											...
											<tr>
												...
												<td style="width:491px;" class="bg_02" align="left" valign="middle">
													...
													({if $event.image_filename3})
														<img src="({t_img_url filename=$event.image_filename3 w=120 h=120})">
														<a href="({t_url m=pc a=do_c_event_edit_delete_c_commu_topic_comment_image})&amp;target_c_commu_topic_id=({$event.c_commu_topic_id})&amp;pic_delete=3&amp;sessid=({$PHPSESSID})">
														削除</a>
														<br>
													({/if})
													...
													<table border="0" cellspacing="0" cellpadding="0" style="width:100%;height:2em;">
														<tr>
															...
															<td style="width:50%;text-align:left;">
																...
																&nbsp;<input type="submit" class="submit" name="cancel" value="　キャンセル　">
...
<!-- ここから：小タイトル -->
										...
										<table border="0" cellspacing="0" cellpadding="0" style="width:644px;">
											<tr>
												<td style="width:36px;" class="bg_06">
													<img src="({t_img_url_skin filename=content_header_1})" style="width:30px;height:20px;" class="dummy"></td>
												<td style="width:440px;padding:2px 0px;" class="bg_06">
													<span class="b_b c_00">このイベントを削除する</span></td>
