...
<!-- ******ここから：メッセージ作成****** -->
				<table border="0" cellspacing="0" cellpadding="0" style="width:650px;" class="border_07">
					<tr>
						...
						<td style="width:636px;" class="bg_00">
...
<!-- ここから：小タイトル -->
						<table border="0" cellspacing="0" cellpadding="0" style="width:636px;" class="border_01">
							<tr>
								...
								<span class="b_b c_00">メッセージを送る</span></td>
							</tr>
						</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
({*********})
							<tr>
								...
								<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_member.c_member_id})">
								({$target_member.nickname|t_body:'name'})</a>
...
({*********})
							...
							<tr>
								<td style="width:1px;" class="bg_01" align="center">
								<img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
								<td style="width:634px;height:40px;" class="bg_03" align="center" valign="middle" colspan="3">
