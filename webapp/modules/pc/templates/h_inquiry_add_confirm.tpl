...
<input type="hidden" name="a" value="do_h_inquiry_add_confirm">
...
<span class="b_b c_00">管理人へ問い合わせ・迷惑ユーザを報告する</span></td>
</tr>
</table>
</div>
<!-- ここまで：小タイトル -->
...
<input type="submit" class="submit" value="管理者へ送信する">
</div>
<img src="./skin/dummy.gif" class="v_spacer_l">
