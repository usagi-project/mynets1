...
<!-- ******************************************** -->
<!-- ******ここから：新しいトピックを作成する****** -->
({t_form m=pc a=page_h_inquiry_add_confirm})
<input type="hidden" name="data_id" value="({$data_id})">
<input type="hidden" name="data_flag" value="({$data_flag})">
...
<span class="b_b c_00">管理人へ迷惑ユーザを報告する</span></td>
</tr>
</table>
</div>
<!-- ここまで：小タイトル -->
...
<select name="category_flag">
    <option value="1" ({if $category_flag == 1}) selected ({/if})>問い合わせ</option>
    <option value="2" ({if $category_flag == 2}) selected ({/if})>迷惑ユーザを報告する</option>
</select>
</div>
</td>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
...
<td style="width:481px;" class="bg_02" align="left" valign="middle">
<div class="padding_s">
({$data_flag_name})&nbsp;対象となる相手&nbsp;({$target_c_member.c_member_id}):({$target_c_member.nickname|t_body:'name'})
</div>
</td>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
</tr>
...
({if $data_flag == 2})c_message_id=({$data_id})({/if})
</div>
</td>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
</tr>
...
<font color="red"><b>
サイト管理人へ問い合わせまたは迷惑ユーザを報告する場合は入力してください。<br>※迷惑ユーザの報告に関しては確認後対処いたします。
<br>問題がないのに迷惑ユーザの報告などを行うなどした場合は、管理人から注意されますので悪戯での報告はおやめ下さい。<br>
