...
({t_form m=pc a=do_fh_dengon_insert_c_dengon_comment})
<input type="hidden" name="sessid" value="({$PHPSESSID})">
<input type="hidden" name="target_c_member_id" value="({$form_val.target_c_member_id})">
...
({t_form _enctype=file m=pc a=page_fh_dengon})
<input type="hidden" name="target_c_member_id" value="({$form_val.target_c_member_id})">
<input type="hidden" name="body" value="({$form_val.body})">
