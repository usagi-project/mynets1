...
<td style="width:36px;" class="bg_06"><img src="({t_img_url_skin filename=content_header_1})" style="width:30px;height:20px;" class="dummy"></td>
<td style="width:598px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">
({$c_member.nickname|t_body:'name'})さんのレビュー一覧
</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
...
<img src="./skin/dummy.gif" style="width:100px;height:1px;" class="dummy">
...
<img src="./skin/dummy.gif" style="width:352px;height:1px;" class="dummy">
