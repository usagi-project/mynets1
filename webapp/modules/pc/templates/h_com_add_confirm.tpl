...
({if $form_val.open_flag == 1})コミュニティを外部公開する({else})外部公開しない({/if})<br>
...
({t_form m=pc a=do_h_com_add_insert_c_commu})
