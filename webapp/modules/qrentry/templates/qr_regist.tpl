...
({if $msg == ''})
    ...
    <br><br>
    <div>&nbsp;&em_pen;<a href="({t_url m=qrentry a=page_qr_regist_input})&amp;ses=({$ses})">新規登録はこちら</a><br></div><font size="1"><br></font>
    <!--<div>&nbsp;&em_pen;<a href="({t_url m=ktai a=page_qr_friend})&amp;c_member_id_invite=({$c_member_id_invite})">会員のﾌﾚﾝﾄﾞ申請はｺﾁﾗ</a></div>-->
({else})
    ({$msg})
({/if})
<table cellSpacing=0 cellPadding=0 width="100%" bgColor=#3399ff border=0>
