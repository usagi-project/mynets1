...
ALTER TABLE c_commu
    ADD topic_authority_role tinyint(2) NOT NULL DEFAULT '0' AFTER open_flag;

ALTER TABLE c_commu_member
    ADD c_commu_topic_admin tinyint(1) NOT NULL DEFAULT '0' AFTER is_receive_message;

ALTER TABLE c_image
    ADD c_member_id int(11) NOT NULL DEFAULT '0' AFTER type,
    ADD INDEX c_member_id (c_member_id);

ALTER TABLE c_one_word
    ADD c_one_word_id_to int(11) NOT NULL DEFAULT '0' AFTER c_member_id,
    ADD INDEX c_one_word_id_to (c_one_word_id_to);
