...
ALTER TABLE `c_member` MODIFY COLUMN public_flag_diary enum('open','public','friend','private') NOT NULL default 'public';
...
ALTER TABLE c_commu_topic
    ADD e_datetime datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '' AFTER event_flag,
    ADD INDEX e_datetime (e_datetime);

ALTER TABLE c_diary
    MODIFY public_flag enum('public','friend','private','open') NOT NULL DEFAULT 'public' COMMENT '';
...
ALTER TABLE c_member_secure
    ADD pc_address_aes text NOT NULL DEFAULT '' AFTER easy_access_id,
    ADD ktai_address_aes text NOT NULL DEFAULT '' AFTER pc_address_aes,
    ADD regist_address_aes text NOT NULL DEFAULT '' AFTER ktai_address_aes,
    ADD easy_access_id_aes text NOT NULL DEFAULT '' AFTER regist_address_aes;
