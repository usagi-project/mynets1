...
echo "<div align='center'><a href='mailto:{$mail}?body=GPS誤差レベル(SoftBank):{$smaj}%0D%0A&#60;cmd src=\"gmaps\" args=\"17,{$laaa},{$looo}\"&#62;'>下記マップでメール作成</a><br>";
...
echo "<br><a href='location:auto?url=".OPENPNE_URL."gmaps/gpssoftbank.php/{$ksid}/{$mail}'>再計測</a><br>";
